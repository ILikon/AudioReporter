function Initialize()
	...
	--MeasureBass = SKIN:GetMeasure('MeasureAudioBassVal')
	--MeasureTreb = SKIN:GetMeasure('MeasureAudioTrebleVal')
...
function Update()
	...
	-- TrebOut = 0
	if true then
		if Beat == true then ColorCode = (ColorCode + 1) % 3 end
		-- ColorCode = 0
		
		SKIN:Bang("!SetOption MeasureAudioBassVal Formula " .. BassVal)
		SKIN:Bang("!SetOption MeasureAudioTrebleVal Formula " .. TrebVal)
		SKIN:Bang("!SetOption MeasureAudioBassMax Formula " .. BassMax)
		SKIN:Bang("!SetOption MeasureAudioTrebleMax Formula " .. TrebMax)
		SKIN:Bang("!SetOption MeterShapeBass Y " .. 900 - 0.92 * BassMax * 300)
		SKIN:Bang("!SetOption MeterShapeTreb Y " .. 900 - 0.7 * TrebMax * 300)
		--SKIN:Bang("!SetOption MeasureAudioBassOut Formula " .. BassOut)
		if ColorCode == 0 then
			SKIN:Bang("!SetOption MeterBarBassOut SolidColor 255,0,0," .. math.floor(BassOut*255))
			SKIN:Bang("!SetOption MeterBarTrebleOut SolidColor 255,0,0," .. math.floor(TrebOut*255))
		elseif ColorCode == 1 then
			SKIN:Bang("!SetOption MeterBarBassOut SolidColor 0,255,0," .. math.floor(BassOut*255))
			SKIN:Bang("!SetOption MeterBarTrebleOut SolidColor 0,255,0," .. math.floor(TrebOut*255))
		elseif ColorCode == 2 then
			SKIN:Bang("!SetOption MeterBarBassOut SolidColor 0,0,255," .. math.floor(BassOut*255))
			SKIN:Bang("!SetOption MeterBarTrebleOut SolidColor 0,0,255," .. math.floor(TrebOut*255))
		end
	end
